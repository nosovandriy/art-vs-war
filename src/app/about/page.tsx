      ...
      <div className={style.articleBlock}>
        <article className={style.article}>
          ...
          <p className={style.text}>
            ...
            <br />
            <br />
            It may sound ambitious, but it&apos;s a straightforward win-win
            situation for all, artists, customers and ourselves, allowing us to
            contribute meaningfully to Ukraine, as a significant portion of each
            payment is allocated to charity.
          </p>
        </article>
        <article className={style.article}>
          ...
          <p className={style.text}>
            ...
            share their work with the world while making a positive impact.
            <br />
            <br />
            The paintings available on our site are not only beautiful works of
            art but they also tell a story. Each piece reflects the unique
      ...
      <div className={style.articleBlock}>
        <article className={style.article}>
          ...
          <p className={style.text}>
            ...
            <br />
            <br />
            We believe that it is important for our supporters to know exactly
            how funds are put to use and the impact that it is having.
          </p>
        </article>
        <article className={style.article}>
          ...
          <p className={style.text}>
            ...
            dedication to helping Ukraine.
            <br />
            <br />
            Their work is a testament to the power of art and the human spirit
            and we are honored to be able to showcase their talents.
          </p>
        </article>
      </div>
